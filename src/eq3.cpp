...
struct EQ3Widget : ModuleWidget {
	EQ3Widget(EQ3 *module) : ModuleWidget(module) {
		...
		addInput(Port::create<PJ301MPort>(Vec(10.5, 276), Port::INPUT, module, EQ3::IN1_INPUT));
		addOutput(Port::create<PJ301MPort>(Vec(11, 320), Port::OUTPUT, module, EQ3::OUT1_OUTPUT));
	}
};
